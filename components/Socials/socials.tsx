...
const SocialBeamSection = () => {
  ...
  const portfolioRef = useRef<HTMLDivElement>(null);
    ...
    const socials = [
    { ref: githubRef, icon: Github, href: "https://github.com/Laiba-Asif", label: "GitHub" },
    { ref: linkedinRef, icon: Linkedin, href: "https://linkedin.com/in/laibae-awan", label: "LinkedIn" },
    { ref: twitterRef, icon: Twitter, href: "https://leetcode.com/u/laiba-asif/", label: "LeetCode" },
    { ref: emailRef, icon: Mail, href: "mailto:laibae.awan@gmail.com", label: "Email" },
    { ref: instagramRef, icon: Instagram, href: "https://www.instagram.com/laibae_awan/", label: "Instagram" },
    { ref: portfolioRef, icon: Globe, href:    `https://wa.me/923296263929?text=Hello,%20I%20reviewed%20your%20portfolio%20and%20would%20like%20to%20connect%20regarding%20a%20potential%20opportunity.`, label: "Whatsapp" },
  ];
