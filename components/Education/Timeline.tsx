...
const TimelineCard = ({ event, index, total }: TimelineCardProps) => {
  ...
  return (
    ...
    >
      ...
      >
        <div className="relative overflow-hidden rounded-2xl border border-white/10 bg-[#0d1117] p-6 shadow-2xl transition-all duration-300 hover:border-accent/50 hover:shadow-[0_0_40px_rgba(0,255,136,0.15)]">
