...
const testimonials = [
  {
    ...
    content: "I have been working with Mr. Laiba Asif for the past 2y on multiple side projects related to Python, Java, and AI, and i must say that he focuses more on detail, and also has great analytical and problem solving skills. Would be delighted to work with him in the future.",
    rating: 5,
  },
  {
    id: 2,
