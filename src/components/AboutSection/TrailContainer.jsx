...
const TrailContainer = () => {
  ...
  useEffect(() => {
    ...
    const images = Array.from({ length: trailImageCount }, (_, i) => `/trail-images/img${i + 1}.jpeg`)
  ...
  return <div ref={trailContainerRef} className="absolute w-full h-full overflow-hidden z-10" />
}
