...
const About = () => {
  return (
    <section
      id="about"
      className="flex relative p-5 md:px-16  w-full h-full z-50 "
    >
      <GradientSphere
      ...
      <div className="flex flex-row  max-md:flex-col w-full  ">
        <div className="md:w-[580px] md:max-w-[45%] my-4 overflow-y-auto  z-50 min-h-full  flex items-center justify-start  ">
          <Svgs />
        </div>
